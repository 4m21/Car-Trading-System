    ...
    public partial class UpdatePartForm : Form
    {
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                RefreshDataGrid();
                MessageBox.Show("Car Part details successfully updated!", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        ...
        private void UpdateCarPartDetails()
        {
            carpartdetail.part_name = txt_name.Text;
            carpartdetail.part_price = int.Parse(txt_price.Text);
            carpartdetail.part_stock = int.Parse(txt_stock.Text);
            carpartdetail.part_desc = txt_desc.Text;
